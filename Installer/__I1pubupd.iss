...
#ifnexist "_DEBUG"
OutputBaseFilename=Setup_RPGAutoClickerProSuite_5_8_0_3
#else
OutputBaseFilename=Setup_RPGAutoClickerProSuite_5_8_0_3d
#endif
...
begin
  ...
  begin
    ...
    WizardForm.PasswordEditLabel.Caption := 'Password 5.8.0.3 is already entered.'
    WizardForm.PasswordEdit.Text := '5.8.0.3'
  end;
end;
...
[CustomMessages]
AppName=RPG AutoClicker Professional Suite for Windows version 5.8.0.3
